...
<div class="px-4 pb-8 sm:px-6 lg:px-8 bg-white border border-gray-200 rounded-md">
    <div class="sm:flex sm:items-center mt-6">
        <div class="sm:flex-auto">
            <h1 class="text-base font-semibold leading-6 text-gray-900">Edit Lunch Item</h1>
        </div>
    </div>
            ...
            <div class="py-2 align-middle sm:px-6 lg:px-8 w-[800px]">
                <form action="{{ route('admin.lunch.update', $lunch->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="item" class="block mt-1 w-full" type="text" name="item" value="{{ $lunch->item }}"
